...
function khaown_food_menu_page_customize_register( $wp_customize ) {
    ...
    *********************************/
	...
	// Button color
	$khaown_load_more_btn_colors[] = array(
		'slug'		=>'khaown_food_menu_load_more_button_color', 
		'default' 	=> '#333347',
		'label' 	=> 'Button Color'
	);
	// Button color
	$khaown_load_more_btn_colors[] = array(
		'slug'		=>'khaown_food_menu_load_more_button_text_color', 
		'default' 	=> '#d2d2d2',
		'label' 	=> 'Button Text Color'
	);
	// Button color
	$khaown_load_more_btn_colors[] = array(
		'slug'		=>'khaown_food_menu_load_more_button_border_color', 
		'default' 	=> '#333347',
		'label' 	=> 'Button Border Color'
	);
	// Button color
	$khaown_load_more_btn_colors[] = array(
		'slug'		=>'khaown_food_menu_load_more_button_hover_color', 
		'default' 	=> '#f8f8f8',
		'label' 	=> 'Button Hover Color'
	);
	// Button color
	$khaown_load_more_btn_colors[] = array(
		'slug'		=>'khaown_food_menu_load_more_button_hover_text_color', 
		'default' 	=> '#333347',
		'label' 	=> 'Button Hover Text Color'
	);
	// Button color
	$khaown_load_more_btn_colors[] = array(
		'slug'		=>'khaown_food_menu_load_more_button_hover_border_color', 
		'default' 	=> '#333347',
		'label' 	=> 'Button Hover Border Color'
    );
    
	foreach( $khaown_load_more_btn_colors as $rsv_header_color ) {
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				$rsv_header_color['slug'], 
				array('label' => $rsv_header_color['label'], 
				'section' => 'khaown_food_menu_load_more_button',
				'priority' 		=>  20,
				'settings' => $rsv_header_color['slug'])
			)
		);
